...
🛒A full-stack E-Commerce web application built with Node.js, Express.js, MongoDB, EJS, and JavaScript. The project includes user authentication, product management, shopping cart functionality, order management, and an admin dashboard.
